...
Original file is located at
    https://colab.research.google.com/drive/1lqnqGfIA_n2Cs4wnJBsFGYY8i4Mr1XiV
"""

#KarenLema
#tipo de variable : condición de empleo sexo == Hombre
import numpy as np
import pandas as pd
...
#IMPORTAR DATOS
datos = pd.read_csv("/content/sample_endi_model_10p.txt", sep=";")
print(datos)
...
#nombrando los sexos
datos["sexo"] = datos["sexo"].apply(lambda x: "Hombre" if x == 1 else "Mujer")
...
empleo_hombre = datos[(datos["sexo"] == "Hombre") & (datos["condicion_empleo"] )]

# Población total de niños
cantidad_ninos = len(empleo_hombre)
print(cantidad_ninos)

# Conteo de los niños en cada condicion de empleo
n_ninos= empleo_hombre['condicion_empleo'].value_counts()
print(n_ninos)
...
# Seleccionar unicamente observaciones de hombre con valores validos en condicion de actividad
datos_hombres_quintil = datos_limpios[(datos_limpios['sexo'] == 'Hombre') & (datos_limpios['condicion_emp_b'] == 1)]

# Seleccionar las variables relevantes
variables = ['n_hijos', 'sexo', 'condicion_empleo', 'quintil']

# limpiando faltantes
for i in variables:
    datos_hombres_quintil = datos_hombres_quintil[~datos_hombres_quintil[i].isna()]


# Contabilizar los niñxs en condicion de empleo.
conteo_por_quintil = datos_hombres_quintil.groupby(["sexo", "condicion_empleo"]).size()
